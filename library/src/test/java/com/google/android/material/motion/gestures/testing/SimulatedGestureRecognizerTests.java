...
public class SimulatedGestureRecognizerTests {
  ...
  public void settableState() {
    assertThat(gestureRecognizer.getState()).isEqualTo(GestureRecognizer.POSSIBLE);

    gestureRecognizer.setState(GestureRecognizer.CHANGED);
    assertThat(gestureRecognizer.getState()).isEqualTo(GestureRecognizer.CHANGED);
  }
}
